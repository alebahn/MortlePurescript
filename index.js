...
(function($PS) {
  ...
  var loadContinueLevel = function __do() {
      ...
      var v = Control_Bind.bind(Data_Maybe.bindMaybe)(maybeCookie)(function (v1) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Int.fromString(v1.value))(function (levelInt) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(levelInt);
          });
      });
      ...
      throw new Error("Failed pattern match at Game (line 202, column 3 - line 208, column 35): " + [ v.constructor.name ]);
  };
  var saveContinueLevel = function (continueLevel) {
      var cookie = {
          key: levelCookieName,
          value: Data_Int.toStringAs(Data_Int.decimal)(continueLevel)
      };
      return function __do() {
          var now = Data_JSDate.now();
          var expire = Data_JSDate.fromTime(99999.0 + Data_JSDate.getTime(now));
          var opts = {
              domain: Data_Maybe.Nothing.value,
              expires: new Data_Maybe.Just(expire),
              httpOnly: false,
          ...
          Browser_Cookie.setCookie({
              cookie: cookie,
              opts: new Data_Maybe.Just(opts)
          })();
  ...
  var getYCoordinateFromMenuOption = function (v) {
      ...
      throw new Error("Failed pattern match at Game (line 446, column 1 - line 446, column 53): " + [ v.constructor.name ]);
  };
  var getStartLevel = function (game) {
      if (game.menuOption instanceof NewGame) {
          return 0;
      };
      if (game.menuOption instanceof Continue) {
          return game.continueLevel;
      };
      throw new Error("Failed pattern match at Game (line 328, column 22 - line 330, column 33): " + [ game.menuOption.constructor.name ]);
  };
  ...
  var drawLevel = function (game) {
      ...
      throw new Error("Failed pattern match at Game (line 416, column 3 - line 420, column 20): " + [ maybeLevelData.constructor.name ]);
  };
  ...
  var checkCollision = function (game) {
      return function (x) {
          return function (y) {
              ...
              throw new Error("Failed pattern match at Game (line 454, column 27 - line 470, column 26): " + [ v.constructor.name ]);
          };
      };
  };
  var invertPixel = function (game) {
      return function (x) {
          return function (y) {
              ...
              var $39 = checkCollision(game)(x)(y);
              if ($39) {
                  return function __do() {
  ...
  var advanceToNextLevel = function (game) {
      return {
          ...
          nextState: (function () {
              var $49 = (game.nextLevel + 1 | 0) >= Data_Array.length(levels);
              if ($49) {
                  return Win.value;
              };
              return Aim.value;
          ...
          continueLevel: game.continueLevel
      };
  };
      ...
      return function (game) {
          if (v instanceof Frame) {
              var refreshScreen = (function () {
                  var $52 = Data_Eq.notEq(eqGameState)(game.currentState)(game.nextState);
                  if ($52) {
              ...
              if (game$prime.currentState instanceof Launch) {
                  var $55 = game.currentX >= 90.0 && game.currentY >= 55.0;
                  if ($55) {
                      return advanceToNextLevel(game$prime);
                  };
                  var $56 = checkCollision(game)(game.currentX)(game.currentY + 1.0);
                  if ($56) {
                      return {
                          ...
                          continueLevel: game$prime.continueLevel
                      };
                  };
                  var game$prime$prime = (function () {
                      var $57 = checkCollision(game)(game.currentX)(game.currentY - 1.0) && game.velocityY < 0.0;
                      if ($57) {
                          return {
                              velocityX: 0.0,
                              velocityY: 0.0,
                      ...
                      var $58 = checkCollision(game)(game.currentX - 1.0)(game.currentY) && game.velocityX < 0.0 || checkCollision(game)(game.currentX + 1.0)(game.currentY) && game.velocityX > 0.0;
                      if ($58) {
                          return {
                              velocityX: -game$prime.velocityX,
                              aimAngle: game$prime.aimAngle,
                  ...
                  return {
                      ...
                      continueLevel: game$prime$prime.continueLevel
                  };
              };
              return game$prime;
          };
          ...
          if (game.currentState instanceof Menu) {
              ...
              return {
                  ...
                  paintScreen: game$prime.paintScreen,
                  currentLevel: game$prime.currentLevel,
                  nextLevel: getStartLevel(game$prime),
                  currentX: game$prime.currentX,
                  currentY: game$prime.currentY,
                  aimAngle: game$prime.aimAngle,
                  velocityX: game$prime.velocityX,
          ...
          if (game.currentState instanceof Win) {
              return makeGame(game.canvasElement)(game.canvasContext)(game.width)(game.height)(game.continueLevel);
          };
          return game$prime;
      };
  };
  ...
  var start = function (canvasElement) {
      return function __do() {
          ...
          var continueLevel = loadContinueLevel();
          var game = makeGame(canvasElement)(context)(dimensions.width)(dimensions.height)(continueLevel);
